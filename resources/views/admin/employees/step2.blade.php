        ...
        <div id="qual-items">
                ...
                <div class="qual-item border border-secondary rounded p-3 mb-3">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="qualifications[{{ $index }}][percentage]"
                                   class="form-control" value="{{ $qual->percentage }}">
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="qual-item border border-secondary rounded p-3 mb-3">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label class="form-label">Start Date</label>
                        <input type="date" name="qualifications[0][start_date]"
                               class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">End Date</label>
                        <input type="date" name="qualifications[0][end_date]"
                               class="form-control">
                    </div>
...
@push('scripts')
<script>
let qCount = {{ $employee->qualifications->count() > 0 ? $employee->qualifications->count() : 1 }};
document.getElementById('add-qual').addEventListener('click', function() {
    ...
    div.innerHTML = `
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <label class="form-label">Institution Name</label>
                <input type="text" name="qualifications[${qCount}][institution_name]"
                       class="form-control" placeholder="Type here...">
            </div>
            <div class="col-md-4">
                <label class="form-label">Field of Study</label>
                <input type="text" name="qualifications[${qCount}][field_of_study]"
                       class="form-control" placeholder="e.g. Computer Science">
            </div>
            <div class="col-md-4">
                <label class="form-label">Start Date</label>
                <input type="date" name="qualifications[${qCount}][start_date]"
                       class="form-control">
            </div>
            <div class="col-md-4">
                <label class="form-label">End Date</label>
                <input type="date" name="qualifications[${qCount}][end_date]"
                       class="form-control">
            </div>
            <div class="col-md-4">
                <label class="form-label">Percentage / CGPA</label>
                <input type="text" name="qualifications[${qCount}][percentage]"
