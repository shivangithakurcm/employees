...
@section('page-title', 'Project Type Master')
@section('content')
...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="text-warning mb-0 fw-bold">
            <i class="fas fa-project-diagram me-2"></i>Project Type Master
        </h4>
        <small class="text-muted">Manage project type options</small>
    </div>
    {{-- Add Button top right --}}
    <button class="btn btn-gold" onclick="openAddModal()">
        <i class="fas fa-plus me-1"></i>Add Project Type
    </button>
</div>
...
<div class="card-dark">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center">
        ...
        <p class="text-muted mb-0">
            ...
            No project types added yet. Click "Add Project Type" to start.
        </p>
        @endforelse
    </div>
...
<div class="pt-modal-overlay" id="addModal">
    <div class="pt-modal-box">
        ...
        <h5><i class="fas fa-plus-circle me-2"></i>Add Project Type</h5>
        <form method="POST" action="{{ route('admin.master.project_type.store') }}">
            @csrf
            <div class="mb-3">
                <label class="form-label text-muted" style="font-size:13px;">Project Type Name</label>
                <input type="text" name="name"
                       class="form-control bg-dark text-white border-secondary"
                       placeholder="e.g. ERP, Mobile App, CRM..."
...
<div class="pt-modal-overlay" id="editModal">
    <div class="pt-modal-box">
        ...
        <h5><i class="fas fa-pen me-2"></i>Edit Project Type</h5>
...
function openEditModal(id, name) {
    ...
    document.getElementById('editForm').action = '/admin/master/project-type/' + id;
...
function confirmDelete(id) {
    document.getElementById('deleteForm').action = '/admin/master/project-type/' + id;
